...
export T5_MODEL_PATH="flan-t5-xl Path"
export T5_TOKENIZER_PATH="flan-t5-xl Path"

PROMPT_FILE=Your Prompt Path"


accelerate launch --num-processes 8 --main_process_port $RANDOM_PORT simpar/sample/sample_t2i.py \
